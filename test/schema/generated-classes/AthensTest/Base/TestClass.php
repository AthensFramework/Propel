...
abstract class TestClass implements ActiveRecordInterface 
{
    ...
    public function getFieldTimestamp($format = NULL)
    {
        if ($format === null) {
            ...
            return $this->field_timestamp instanceof \DateTimeInterface ? $this->field_timestamp->format($format) : null;
        }
    }
    ...
    public function setFieldTimestamp($v)
    {
        ...
        if ($this->field_timestamp !== null || $dt !== null) {
            if ($this->field_timestamp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->field_timestamp->format("Y-m-d H:i:s.u")) {
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 9; // 9 = TestClassTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTestClassQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'field_timestamp':                        
                        $stmt->bindValue($identifier, $this->field_timestamp ? $this->field_timestamp->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'field_boolean':
